    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address_num', models.CharField(blank=True, max_length=5, null=True, unique=True)),
                ...
                ('apcan_phone', models.CharField(max_length=14, null=True, unique=True)),
                ...
                ('zir_block_kg', models.FloatField(blank=True, null=True)),
                ('zir_block_count', models.IntegerField(blank=True, null=True)),
                ('zir_powder_kg', models.FloatField(blank=True, null=True)),
                ('zir_powder_count', models.IntegerField(blank=True, null=True)),
                ('round_bar_kg', models.FloatField(blank=True, null=True)),
                ('round_bar_count', models.IntegerField(blank=True, null=True)),
                ('tool_kg', models.FloatField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('got_num', models.CharField(max_length=11, null=True)),
            ],
        ),
    ]
